<div class="modal inmodal" id="userEditModal_{{$idx}}" tabindex="-1" role="dialog" aria-hidden="true"
     style="display: none;">

    <form action="/user/edit_user" method="post" accept-charset="UTF-8" class="form-horizontal"
        ...
        <div class="modal-dialog">
            <div class="modal-content animated bounceInDown">
                ...
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">ユーザーの編集</h4>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-10 col-sm-6">
                                <input type="checkbox" name="enable_flg" value="1"
                                       class="form-control" {{ old("enable_flg", $user->enable_flg)=="1"?"checked":"" }}>
                            </div>
                        </div>
