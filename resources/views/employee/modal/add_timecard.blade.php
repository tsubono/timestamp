<div class="modal inmodal" id="timecardAddModal" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;"
    ...
    <form action="/employee/add_timecard" method="post" accept-charset="UTF-8" class="form-horizontal" id="addForm"
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-10 col-sm-6">
                                <input type="text" name="employee_uid_text" value="{{e($employee->name)}}" class="form-control" readonly>
